...
for PARTITION in 0 1 2; do
    for DILUTION in 1 2 3; do
        ...
        INFILE=examples/updated/cogsci-pmsp-added-partition-$PARTITION-dilution-$DILUTION.ex

        OUTFILE=examples/updated/freq-$FREQUENCY-partition-$PARTITION-dilution-$DILUTION.ex
